            ...
            <div className="post">
              <div className="post-head">
                <div class="post-info">
                  ...
                  <p>
                    by <span className="author">Miranda Smith</span> in{" "}
                    <span className="category">Business</span> on{" "}
              ...
              <div className="post-body">
                <div className="post-image">
                  <img src="/assets/images/blog/5.jpg" alt="Single Post" />
                </div>
                <div className="post-content">
                  <p>
                    ...
                    neque sed ipsum. Nam quam nunc, blanditvel, luctus pulvinar,
                    hendrerit id, lorem.
                  </p>
                  <p>
                    <b>Key Features:</b>
